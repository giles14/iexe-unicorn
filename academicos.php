    ...
    <div class="container">
        ...
        <div class="row galeria">
            ...
            <div style="height: 180px;" class="col-4">
                ...
                <div class="bloque-foto d-table" style="margin: 0px 0 6px 6px;"><img src="<?php echo get_template_directory_uri() ?>/assets/img/rect-2.webp" class="img-fluid" alt=""></div>
                <div class="bloque-foto d-table" style="margin: 6px 6px 0 0;"><img src="<?php echo get_template_directory_uri() ?>/assets/img/rect-3.webp" class="img-fluid" alt=""></div>
                <div class="bloque-foto d-table" style="margin: 6px 0 0 6px;"><img src="<?php echo get_template_directory_uri() ?>/assets/img/rect-4.webp" class="img-fluid" alt=""></div> 
            </div>
            <div style="height: 372px;" class="col-4"><div class="block"></div></div>
        </div>
        <div class="row galeria">
            <div style="height: 180px;" class="col-4">
                <div class="bloque-foto d-table" style="margin: 0 6px 6px 0;"><img src="<?php echo get_template_directory_uri() ?>/assets/img/rect-1.webp" class="img-fluid" alt=""></div>
                <div class="bloque-foto d-table" style="margin: 0px 0 6px 6px;"><img src="<?php echo get_template_directory_uri() ?>/assets/img/rect-2.webp" class="img-fluid" alt=""></div>
                ...
                <div class="bloque-foto d-table" style="margin: 6px 0 0 6px;"><img src="<?php echo get_template_directory_uri() ?>/assets/img/rect-3.webp" class="img-fluid" alt=""></div> 
            </div>
            <div style="height: 372px;" class="col-4"><div class="block"></div></div>
            <div style="height: 180px;" class="col-4">
                <div class="bloque-foto d-table" style="margin: 0 6px 6px 0;"><img src="<?php echo get_template_directory_uri() ?>/assets/img/rect-2.webp" class="img-fluid" alt=""></div>
                ...
                <div class="bloque-foto d-table" style="margin: 6px 6px 0 0;"><img src="<?php echo get_template_directory_uri() ?>/assets/img/rect-2.webp" class="img-fluid" alt=""></div>
                <div class="bloque-foto d-table" style="margin: 6px 0 0 6px;"><img src="<?php echo get_template_directory_uri() ?>/assets/img/rect-2.webp" class="img-fluid" alt=""></div> 
            </div>
        </div>
        <div class="row">
