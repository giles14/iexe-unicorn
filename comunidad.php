...
<section id="banner-libro">
    <div class="container">
        <div class="row">
            <div class="col">
                <a href="http://bit.ly/3Gk5j5y"><img class="img-fluid d-none d-sm-block" src="<?php echo esc_url(get_template_directory_uri()) ?>/assets/img/banner_bestseller-politicas-publicas.webp" alt=""></a>
                <a href="http://bit.ly/3Gk5j5y"><img class="img-fluid d-block d-sm-none" src="<?php echo esc_url(get_template_directory_uri()) ?>/assets/img/banner-comunidad-responsive.webp" alt=""></a>
            </div>
        </div>
    </div>
</section>
