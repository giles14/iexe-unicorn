                            ...
                            while( $query->have_posts() ): $query->the_post(); ?>
                                <div class="col-12 col-md-6 mb-4">
                                    <div class="row">
                                        ...
                                        <p class="meta-info"><img class="img-fluid pl-0" src="<?php echo esc_url(get_template_directory_uri()) ?>/assets/img/icons/aw-calendar.png" alt="icono de calendario"><span class="fecha pl-2"><?php the_date('d\/m\/Y') ?></span><img class="img-fluid pl-2" src="<?php echo esc_url(get_template_directory_uri()) ?>/assets/img/icons/aw-clock.png" alt="icono de reloj"><span class="reloj pl-1"><?php echo get_post_meta($post->ID, 'time_to_read', true) . ' min de lectura' ?></span><img class="img-fluid pl-2" src="<?php echo esc_url(get_template_directory_uri()) ?>/assets/img/icons/aw-like.png" alt="icono de calendario"><span class="likes-noticia pl-1">0</span><img src="<?php echo esc_url(get_template_directory_uri()) ?>/assets/img/icons/aw-commen.png" class="img-fluid pl-2" alt="icono de calendario"> <span class="comentarios pl-1"><?php echo get_comments_number() ?></span></p>
                                        </div>
                                    </div>
                                </div>
                                <?php endwhile; ?>
