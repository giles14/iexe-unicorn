...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <!-- <link href="https://fonts.googleapis.com/css2?family=Georama:wdth,wght@100,100;100,200;100,300;100,500;100,600;112.5,900&display=swap" rel="stylesheet"> -->
    <!-- <link href="https://fonts.googleapis.com/css2?family=Georama:wdth,wght@100,100;100,300;100,400;100,500;112.5,900&display=swap" rel="stylesheet"> -->
    <link href="https://fonts.googleapis.com/css2?family=Georama:wdth,wght@112.5,900&display=swap" rel="stylesheet">
...
<body <?php iexe_unicorn_body() ?>>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="el-whatsapp"><a href="javascript:void(0)" class="solicitar-info d-none d-lg-block" data-toggle="modal" data-target="#grid">Solicitar Información</a></div>         
        </div>
