...
<section id="logos-convenio">
  <div class="container">
    ...
    <div class="row contents" id="myItems2">
              ...
              <div class="col-lg-3 col-4 el-convenio mb-3" data-convenio="Colegio de Bachilleres del estado de Puebla COBAEP"><div class="un-convenio" ><a href="#" onclick="updateConvenio(this)"  data-toggle="modal" data-target="#modal-beca-convenios" data-idconv="116"><img src="<?php echo esc_url(get_template_directory_uri()) ?>/assets/img/logos-convenios/cobaep.png" alt="" class="container-fluid" ></a></div> </div>
      ...
      <div class="col-lg-6">
        <div class="contactanos">
          ...
          <ul class="elementos-landing">
            <li><i class="sprite sprite-mail_iexe"></i>delagarza.greta@iexe.edu.mx</li>
